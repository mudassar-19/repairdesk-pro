...
export const dictionary = {
  ...
  pos: {
    ...
    tabNewOrder: { en: 'New Order', ur: 'نیا آرڈر' },
    tabDeliverOrder: { en: 'Deliver Order', ur: 'آرڈر ڈیلیور کریں' },
    deliverOrder: { en: 'Deliver an Order', ur: 'آرڈر ڈیلیور کریں' },
    deliverSearch: { en: 'Search by customer, phone, or device', ur: 'گاہک، فون یا ڈیوائس سے تلاش کریں' },
    dateCreatedLabel: { en: 'Order created', ur: 'آرڈر بنایا گیا' },
    createdOn: { en: 'Created', ur: 'بنایا گیا' },
    noUndelivered: { en: 'No undelivered orders match your search.', ur: 'آپ کی تلاش سے کوئی غیر ڈیلیور شدہ آرڈر نہیں ملا۔' },
    selectToDeliver: { en: 'Select an order from the list to deliver it.', ur: 'ڈیلیور کرنے کے لیے فہرست سے آرڈر منتخب کریں۔' },
    deliveredDone: { en: 'This order is delivered.', ur: 'یہ آرڈر ڈیلیور ہو گیا ہے۔' },
    backToList: { en: 'Back to list', ur: 'فہرست پر واپس' }
  },
  auth: {
  ...
  dashboard: {
    ...
    repairsNeedingAction: { en: 'Repairs Needing Action', ur: 'توجہ طلب مرمتیں' },
    nothingNeedsAction: { en: 'Nothing needs action right now.', ur: 'ابھی کسی مرمت پر توجہ درکار نہیں۔' },
  ...
  repairs: {
    ...
    dateYesterday: { en: 'Yesterday', ur: 'کل' },
