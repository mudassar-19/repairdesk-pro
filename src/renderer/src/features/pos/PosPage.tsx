...
/**
 * POS Mode (Part I) — one focused, full-screen order-creation flow: pick/create
 * a customer, capture the repair, and choose how the order leaves (in for
 * repair, taken paid-in-full, or taken on credit) — then Save & Print in a
 * single action, and reset for the next customer. Reuses everything: the
 * shared CustomerPicker, the shared repairForm schema/validation, the Part A
 * delivery services, and the existing ReceiptModal template. Deliberately
 * carries none of the browsing/reporting surfaces — those stay in Dashboard mode.
 */
export function PosPage() {
  ...
  return (
    <div className="flex h-screen w-screen flex-col overflow-hidden bg-bg">
      <header className="flex flex-shrink-0 items-center justify-between border-b border-border bg-surface px-xl py-md">
        <div className="flex items-center gap-sm">
          <span className="rounded-md bg-primary/10 px-2 py-1 text-xs font-semibold text-primary">POS</span>
          <BilingualText text={dictionary.pos.title} as="div" size="lg" />
        </div>
      ...
      <div className="flex flex-1 gap-lg overflow-y-auto p-xl">
        ...
        <div className="flex-1">
          <BilingualText text={dictionary.pos.newOrder} as="div" size="xl" className="mb-lg" />
        ...
        <div className="w-[22rem] flex-shrink-0">
          <BilingualText text={dictionary.pos.orderSummary} as="div" size="xl" className="mb-lg" />
          <Card className="flex flex-col gap-md">
